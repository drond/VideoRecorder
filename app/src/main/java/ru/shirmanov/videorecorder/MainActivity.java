package ru.shirmanov.videorecorder;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initAndConfigureMediaRecorder(){
        ...
        String outpuFile = new File(outputDir,System.currentTimeMillis()+".mp4").getAbsolutePath();
        mediaRecorder.setOutputFile(outpuFile);
